          ...
          <p className="text-center">
            <span className="text-danger mx-3">
              <svg
                ...
                fill="currentColor"
                className={
                  "inline-block " + (state.playing ? "spinner-border" : "")
                }
                viewBox="0 0 16 16"
              >
              ...
              <span className="fw-bolder mt-2 mx-3">
                0:
            ...
            {[...Array(3 - state.strikes)].map((item, index) => {
              return <HeartIcon key={index} className="text-danger mx-1" />;
            })}
            {[...Array(state.strikes)].map((item, index) => {
              return <HeartIcon key={index} className="text-secondary mx-1" />;
            })}
          </p>
          <h1 className="text-center fw-bolder py-3 pb-10">
            ...
            {state.currentQuestion.photos.map((photo, index) => {
              return (
                <img
                  ...
                  key={index}
                  className="col-md-3 img-thumbnail"
                  src={photo}
                  alt="dog"
                />
              );
        ...
        state.currentQuestion && (
          <div className="d-flex flex-column justify-content-around text-center">
            {state.timeRemaining <= 0 && (
              <p className="text-danger mb-4 fw-bold">Time's Up!</p>
            )}
            {state.strikes >= 3 && (
              <p className="display-4 text-danger my-4 fw-bold">
            ...
            <p className="display-3 text-success fw-bold">
              Your score:{" "}
              <span>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
            ...
            <p className="display-4 text-muted my-5">
